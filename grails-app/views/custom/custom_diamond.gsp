...
<head>
    ...
    <script type="text/javascript">
        function Diamond(){
            ...
            this.spinDiamondText = function (elementId) {

                var elem = document.getElementsByClassName('revspin');
                for(var i=0; i<divs.length; i++) {
                    divs[i].style.webkitTransform = "rotate(-"+rotation+"deg)";
                }
            }



            this.spinDiamond = function (elementId) {
                ...
                var timer = setInterval(function () {                         //#4
                    if (tick < 45) {
                        ...
                        //rotateClockwise()
                        rotation++;
                        elem.style.webkitTransform = "rotate("+rotation+"deg)";
                        var divs  = document.getElementsByClassName('revspin');
                        for(var i=0; i<divs.length; i++) {
                            divs[i].style.webkitTransform = "rotate(-"+rotation+"deg)";
                        }
                        tick++;
    ...
    <link rel="stylesheet" type="text/css" href="${resource(dir: 'css', file: 'assert.css')}" />
...
<header class="pagehead" name="intro">
    ...
    <span>
        ...
        <input id="spinButton" type="submit" value="spin" class="prettybutton"/>
    </span>
</header>
...
<section>
    ...
    <div class="crossproduct_angle" id="diamond_holder">
        <script>
            ...
            jQuery('#spinButton').click(function(){
                diamond.spinDiamond('diamond_holder');
            });
        </script>
